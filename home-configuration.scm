...
;; TODO: create my own dwl-guile branch with patches applied
;; cause I can't get the dwl-guile home service to apply local patches
	    ...
	    (home-dwl-guile-configuration
	     (package
	      (patch-dwl-guile-package dwl-guile-latest
				       #:patches (list %patch-xwayland %patch-swallow)))
	     (native-qt? #t)
	     (auto-start? #t)
